...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "Crud_Admin"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{28522562-F10F-4724-B6E9-4D194FBD8423}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", '3fa7LrJAighxgSZF'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/Crud_Admin.css"); // Project stylesheet file name
